<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Services.aspx.cs" Inherits="salonmanagement.view.Services" EnableEventValidation="false"%>
...
<body>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../view/Services.aspx">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            </div>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
      <div class="container-fluid py-1 px-3" />
        <nav aria-label="breadcrumb">
          <h6 class="font-weight-bolder mb-0" style="font-size: 30px;">Service&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3" style="font-size: 20px;">Services</h6>
              </div>
            </div>
            ...
            <div class="card-body px-4 pb-4">
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                    ...
                    <asp:GridView CellPadding="4" Class="table" ID="GridView1" runat="server" DataKeyNames="sid" OnRowDataBound="OnRowDataBound"
      ...
      <div class="row">
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3" style="font-size: 20px;">Add Services</h6>
              </div>
            </div>
          ...
          <div class="input-group input-group-outline mb-3">
              <asp:TextBox ID="add_price" runat="server" CssClass="form-control" placeholder="Username"></asp:TextBox>
          </div>
